...
my_table6_filtered = table5.filter(lambda x: x['gender'] == 'M').filter(lambda x: x['embarked'] == 'Southampton')
print(f"Total number of male passengers embarked at Southampton : {len(my_table6_filtered.table)}")
